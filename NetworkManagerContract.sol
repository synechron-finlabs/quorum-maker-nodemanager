...
contract NetworkManagerContract {
    ...
    function getNodeDetails(uint _index) constant public returns (string n, string r,string p,string ip,string e,string id,uint i) {
    ...
    function getNodeList(uint i)  public  constant   returns (string n, string r,string p,string ip,string e, string id) {
